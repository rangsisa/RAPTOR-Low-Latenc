...
assert.match(indexHtml,/pipeline\.css\?v=compact-top-boundary-20260914-1/);
...
assert.match(indexHtml,/pipeline\.js\?v=empty-exit-canvas-divider-20260914-1/);
assert.match(indexHtml,/pipeline-workspace-theme\.js\?v=control-safe-node-boundary-20260914-1/);
