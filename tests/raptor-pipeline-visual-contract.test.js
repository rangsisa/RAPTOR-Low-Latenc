...
assert.match(indexHtml,/pipeline\.css\?v=empty-exit-canvas-divider-20260914-1/);
assert.match(indexHtml,/<hr class="pipeline-canvas-divider" aria-hidden="true" \/>/);
...
assert.match(pipelineCss,/\.pipeline-canvas-divider\{[^}]*height:4px;[^}]*background:#687681/);
