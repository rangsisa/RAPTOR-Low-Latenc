...
assert.match(indexHtml,/pipeline-workspace-theme\.js\?v=compact-top-boundary-20260914-1/);
...
assert.match(workspaceThemeJs,/const NODE_TOP_BOUNDARY=8/);
assert.match(workspaceThemeJs,/const logicalY=Math\.max\(NODE_TOP_BOUNDARY,/);
