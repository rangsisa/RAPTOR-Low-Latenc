...
assert.match(js,/RaptorCoherenceCandles\.render/);
assert.doesNotMatch(js,/uncertaintyMagnitudeRelief|UNCERTAINTY_CONFIDENCE_FLOOR/);
assert.match(autoEqJs,/max="100" step="any" value="50" required data-autoeq-coherence/);
