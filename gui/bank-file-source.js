(function(root,factory){
  ...
  const SPECS=Object.freeze([
    Object.freeze({id:'bank-file-48k',label:'48K',sampleRateHz:48000,fftSize:32768,maxFrequencyHz:24000,color:'#F6C85F'}),
    Object.freeze({id:'bank-file-96k',label:'96K',sampleRateHz:96000,fftSize:65536,maxFrequencyHz:48000,color:'#36CFC9'}),
    Object.freeze({id:'bank-file-192k',label:'192K',sampleRateHz:192000,fftSize:131072,maxFrequencyHz:96000,color:'#FF2D95'})
  ]);
